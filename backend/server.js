...
app.use('/api/ordenes-trabajo', require('./routes/ordenes_trabajo'));
app.use('/api/ot-plantillas', require('./routes/ot_plantillas'));
...
if (require.main === module) {
  initDb()
    .then(() => {
      ...
      // intervalo de 15 min del resto de los jobs, así que este corre cada 5
      // segundos (ver services/seguimientoBoton.js).
      const CINCO_SEG = 5 * 1000;
      setInterval(() => {
